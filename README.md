...
> **Note:** Newly registered users are assigned the **MEMBER** role by default. Use the Admin credentials above to access features such as **Manage Users**, **Board Management**, **Task Assignment**, and **All Tasks**.
